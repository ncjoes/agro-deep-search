...
switch ($data['status'])
{
    ...
    {
        ?>
        <div class="text-center full-margin-bottom text-info bg-info">No active crawler processes running at the moment</div>
        <?php
    } break;
    case 0 :
    {
        ?>
        <div class="text-center full-margin-bottom text-danger bg-danger">Crawling process has been terminated</div>
        <?php
    } break;
    case 1 :
    {
    ...
    case 2 :
    {
        ...
        <div class="row text-center">
            ...
            <div class="col-sm-3 col-sm-offset-0 col-xs-5 col-xs-offset-0">
